...
const projects = [
  ...
  },
  {
    ...
    title: "So True",
    year: "2024",
    infoen: "feature on opening track of sinlge by R.Kitt",
    infoga: "comhscríbhneoir ar an gcéad rian ar shingil R.Kitt",
    link: "",
  ...
  },
  {
    ...
    link: "",
    descriptionen: "This play was funded through the <i>Scéal na Gaillimhe</i> project. I came up with the play's concept, composed the music and produced the play. The music is written for cello and wire strung harp, played by myself and Méabh McKenna, imitating medieval and traditional styles. <i>Ar An Dé Deiridh</i> was premiered in An Taibhdhearc and brought on tour in Conamara and Árainn July 2024.",
    descriptionga: "Maoinaíodh an dráma seo tríd an togra <i>Scéal na Gaillimhe</i>. Rinne mé coincheap an dráma, an ceol agus léirigh mé an dráma. Scríobhadh an ceol do dhordveidhil agus chláirseach shreinge, seinnte agamsa agus ag Méabh McKenna, ag déanamh aithris ar cheol meánaoise agus traidisiúnta. Seoladh <i>Ar An Dé Deiridh</i> sa Taibhdhearc agus cuireadh ar chamchuairt é i gConamara agus Árainn Iúil 2024.",
    embed: '',
